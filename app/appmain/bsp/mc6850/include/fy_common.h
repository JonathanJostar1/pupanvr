...
typedef FY_S32 VGS_CHN;
typedef FY_S32 VGS_PTH;
...
#define FY_ID_CHNL        FY_ID_LCM
#define MPP_MOD_CHNL      MPP_MOD_LCM

#define FY_ID_IVE        FY_ID_NNA
#define MPP_MOD_IVE      MPP_MOD_NNA
