...
/**********************************************************************************************
    PART II. Extension API
***********************************************************************************************/
VB_POOL FY_MPI_VB_CreatePoolEx(FY_U32 u32BlkSize,FY_U32 u32BlkCnt,const FY_CHAR *pcMmzName, const FY_CHAR *pcMmbName);
FY_S32 FY_MPI_VB_DestroyPoolEx(VB_POOL Pool);
FY_S32 FY_MPI_VB_AddUserCnt(VB_BLK Block);
FY_S32 FY_MPI_VB_SubUserCnt(VB_BLK Block);
