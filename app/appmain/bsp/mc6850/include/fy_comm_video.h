...
typedef enum fyPIXEL_FORMAT_E
{
    ...
    PIXEL_FORMAT_YUV_FIELD_422,     /* cvbs pixelformt*/
    PIXEL_FORMAT_YUV_FIELD_420,
    PIXEL_FORMAT_YUV_FIELD_1D_422,
...
typedef enum fyCOMPRESS_MODE_E
{
    ...
    /*Extension Members*/
    COMPRESS_MODE_128byte   = 0x5,      /*compress type 1D, compress rate 50%*/
    COMPRESS_MODE_160byte   = 0x6,      /*compress type 1D, compress rate 63%*/
    COMPRESS_MODE_192byte   = 0x7,      /*compress type 1D, compress rate 75%*/
    COMPRESS_MODE_TILE_192  = 0x8,      /*compress type TILE,compress rate 50%*/
    COMPRESS_MODE_SLICE     = 0x9,      /*compress type SLICE,*/
    COMPRESS_MODE_CF10      = 0xa,
    COMPRESS_MODE_FBC       = 0xb,
    COMPRESS_MODE_TILE_224  = 0xc,      /*compress type TILE,compress rate 59%*/
    COMPRESS_MODE_TILE_256  = 0xd,      /*compress type TILE,compress rate 67%*/
...
typedef struct fyVIDEO_FRAME_S
{
    ...
    FY_U32			u32SrcExpandInfo;  /*mark srcFrame info*/
}VIDEO_FRAME_S;
