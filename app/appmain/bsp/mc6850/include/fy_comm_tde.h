#ifndef __FY_COMM_TDE_H__
#define __FY_COMM_TDE_H__
...
typedef enum fyTDE_ERR_NUM_E
{
    ERR_TDE_DEV_NOT_OPEN,                    /**<  tde device not open yet */
    ...
    ERR_TDE_INVALID_PARA,                    /**<  invalid parameter */
...
{
    FY_U32              u32PhyAddr;             /* the physical address of picture data */
    TDE2_COLOR_FMT_E    enColorFmt;             /* color format */
    FY_U32              u32Height;              /* picture height */
    FY_U32              u32Width;               /* picture width */
    FY_U32              u32Stride;              /* picture stride */
    FY_U8*              pu8ClutPhyAddr;         /* the physical address of Clut data */
    FY_BOOL             bYCbCrClut;             /* if the Clut is in YCbCr space */
    FY_BOOL             bAlphaMax255;           /* if the alpha max value is 255 */
    FY_BOOL             bAlphaExt1555;          /* for ARGB1555 to extend alpha */
    FY_U8               u8Alpha0;
    FY_U8               u8Alpha1;
...
typedef struct fyTDE2_OPT_S
{
    ...
    TDE2_CLIPMODE_E     enClipMode;            /* Intra-area clip or entra-area clip */
    TDE2_RECT_S         stClipRect;            /* Definition of the clipped area */
    FY_BOOL             bDeflicker;            /* Whether to deflicker */
    TDE2_DEFLICKER_MODE_E enDeflickerMode;     /* anti-flicker mode */
    FY_BOOL             bResize;               /* Whether to scale */
    TDE2_FILTER_MODE_E  enFilterMode;          /* Filtering mode for scaling or anti-flicker */
...
{
    TDE2_CLIPMODE_E     enClipMode;            /* Clip mode: intra-area clip or entra-area clip */
    TDE2_RECT_S         stClipRect;            /* Definition of the clipped area */
    FY_BOOL             bDeflicker;            /* Whether to perform anti-flicker */
    TDE2_MBRESIZE_E     enResize;              /* scaling mode */
    FY_BOOL             bSetOutAlpha;          /* Whether the alpha value of the output result bitmap is specified by users */
    FY_U8               u8OutAlpha;
} TDE2_MBOPT_S;
...
#define FY_ERR_TDE_DEV_NOT_OPEN              FY_DEF_ERR(FY_ID_TDE, EN_ERR_LEVEL_ERROR, ERR_TDE_DEV_NOT_OPEN)
#define FY_ERR_TDE_DEV_OPEN_FAILED           FY_DEF_ERR(FY_ID_TDE, EN_ERR_LEVEL_ERROR, ERR_TDE_DEV_OPEN_FAILED)
#define FY_ERR_TDE_NULL_PTR                  FY_DEF_ERR(FY_ID_TDE, EN_ERR_LEVEL_ERROR, ERR_TDE_NULL_PTR)
#define FY_ERR_TDE_NO_MEM                    FY_DEF_ERR(FY_ID_TDE, EN_ERR_LEVEL_ERROR, ERR_TDE_NO_MEM)
#define FY_ERR_TDE_INVALID_HANDLE            FY_DEF_ERR(FY_ID_TDE, EN_ERR_LEVEL_ERROR, ERR_TDE_INVALID_HANDLE)
#define FY_ERR_TDE_INVALID_PARA              FY_DEF_ERR(FY_ID_TDE, EN_ERR_LEVEL_ERROR, ERR_TDE_INVALID_PARA)
#define FY_ERR_TDE_NOT_ALIGNED               FY_DEF_ERR(FY_ID_TDE, EN_ERR_LEVEL_ERROR, ERR_TDE_NOT_ALIGNED)
#define FY_ERR_TDE_MINIFICATION              FY_DEF_ERR(FY_ID_TDE, EN_ERR_LEVEL_ERROR, ERR_TDE_MINIFICATION)
#define FY_ERR_TDE_CLIP_AREA                 FY_DEF_ERR(FY_ID_TDE, EN_ERR_LEVEL_ERROR, ERR_TDE_CLIP_AREA)
#define FY_ERR_TDE_JOB_TIMEOUT               FY_DEF_ERR(FY_ID_TDE, EN_ERR_LEVEL_ERROR, ERR_TDE_JOB_TIMEOUT)
#define FY_ERR_TDE_UNSUPPORTED_OPERATION     FY_DEF_ERR(FY_ID_TDE, EN_ERR_LEVEL_ERROR, ERR_TDE_UNSUPPORTED_OPERATION)
#define FY_ERR_TDE_QUERY_TIMEOUT             FY_DEF_ERR(FY_ID_TDE, EN_ERR_LEVEL_ERROR, ERR_TDE_QUERY_TIMEOUT)
#define FY_ERR_TDE_INTERRUPT                 FY_DEF_ERR(FY_ID_TDE, EN_ERR_LEVEL_ERROR, ERR_TDE_INTERRUPT)
...
#endif /* End of #ifndef __FY_COMM_TDE_H__ */
